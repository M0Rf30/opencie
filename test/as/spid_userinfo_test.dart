...
void main() {
  group('SPID/CIE UserInfo Endpoints', () {
    ...
    test('SPID userinfo returns URI-keyed claims without standard name/email', () async {
    ...
    test('CIE userinfo returns standard OIDC + URI-style fiscal number', () async {
      ...
      expect(userinfo['https://attributes.eid.gov.it/fiscal_number'], 'TINIT-RSSMRA80A01H501U');
    });
