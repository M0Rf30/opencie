...
//
// PGP biometric word list (Patrick Juola, Philip Zimmermann, 1995).
// Public domain. 256 two-syllable "even" words alternated with 256
// three-syllable "odd" words. Each byte index 0..255 maps to one word
// in each table; alternating between the two tables makes mishearing
// adjacent words highly improbable.

/// Even-position words (two syllables), index 0..255.
const List<String> pgpWordlistEven = [
...
/// Odd-position words (three syllables), index 0..255.
const List<String> pgpWordlistOdd = [
